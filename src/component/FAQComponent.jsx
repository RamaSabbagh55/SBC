...
return(
    <div className='p-2 w-300 h-20  border-1 border-blue-900 rounded-lg justify-center items-center ml-7  transition-all duration-300   hover:shadow-xl  hover:bg-gray-100'>
